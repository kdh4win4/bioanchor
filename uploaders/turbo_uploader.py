...
class TurboUploader:
    ...
    def __init__(
        ...
        """
        Args:
            wallet_path: Path to Arweave JWK JSON file
            wallet_jwk:  JWK dict directly (alternative to wallet_path)
    ...
    def upload(self, manifest: dict) -> str:
        """
        Upload a BioAnchor manifest dict to Arweave via Turbo.

        Args:
            manifest: BioAnchor manifest dictionary

        Returns:
            Arweave Transaction ID (str)
        """
